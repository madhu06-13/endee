...
This project includes or depends on third-party software components licensed under their respective open-source licenses. Use of those components is governed by their own license terms.#  AI Semantic Search App using Endee
> This project is built as an extension of the original Endee repository provided in the assignment.
